...
if __name__ == "__main__":
    ...
    clear_file("debug/cancel.log")
    clear_file("debug/debug.log")
    clear_file("debug/query.log")
    clear_file("debug/test.log")
    clear_file("debug/err.log")

    querylogger = setup_logger("querylogger", "debug/query.log", level=logging.DEBUG)
    cancellogger = setup_logger("cancellogger", "debug/cancel.log", level=logging.DEBUG)
    debuglogger = setup_logger("debuglogger", "debug/debug.log", level=logging.DEBUG)
    errlogger = setup_logger("errlogger", "debug/err.log", level=logging.ERROR)
    resultlogger = setup_logger("resultlogger", "debug/result.log", level=logging.DEBUG)
